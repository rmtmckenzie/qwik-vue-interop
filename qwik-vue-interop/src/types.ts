...
export interface QwikifyBase {
    ...
    'client:load'?: boolean;
    /**
     * The component eagerly hydrates when the browser first becomes idle,
     * ie, when everything important has already run before.
     *
     ...
     *
     * **Use case:** Lowest-priority UI elements whose interactivity is not crucial, and only needs to run in desktop.
     */
