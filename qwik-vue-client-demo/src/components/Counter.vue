...
<template>
  <div class="vue-card">
    <div class="header">
      ...
      <span class="badge client-only">Client-Only Island</span>
    </div>
    <div class="body">
      <p class="desc">This section is fully rendered and animated by <strong>Vue 3</strong>. It executes <em>exclusively</em> on the client side (no SSR markup).</p>
...
<style scoped>
.vue-card {
  background: rgba(230, 100, 65, 0.08);
  border: 1px solid rgba(230, 100, 65, 0.2);
  border-radius: 12px;
  padding: 20px;
...
.btn-vue {
  ...
  gap: 10px;
  width: 100%;
  background: linear-gradient(135deg, #ff6f43 0%, #35495E 100%);
  color: #ffffff;
  border: none;
  padding: 12px 20px;
  font-weight: 600;
